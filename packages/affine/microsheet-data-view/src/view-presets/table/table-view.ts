...
const styles = css`
  ...
  .affine-microsheet-block-table::-webkit-scrollbar {
    -webkit-appearance: none;
    display: block;
  }

  .affine-microsheet-block-table::-webkit-scrollbar:horizontal {
    height: 4px;
  }

  .affine-microsheet-block-table::-webkit-scrollbar-thumb {
    border-radius: 2px;
    background-color: transparent;
  }

  .affine-microsheet-block-table:hover::-webkit-scrollbar:horizontal {
    height: 8px;
  }

  .affine-microsheet-block-table:hover::-webkit-scrollbar-thumb {
    border-radius: 16px;
    background-color: var(--affine-black-30);
  }

  .affine-microsheet-block-table:hover::-webkit-scrollbar-track {
    background-color: var(--affine-hover-color);
  }

  .affine-microsheet-table-container {
    position: relative;
    width: fit-content;
    min-width: 100%;
  }

  .affine-microsheet-block-tag-circle {
    width: 12px;
    height: 12px;
    border-radius: 50%;
    ...
    return html`
      <div class="affine-microsheet-table" style="${wrapperStyle}">
        <div class="affine-microsheet-block-table" @wheel="${this.onWheel}">
          <div
            class="affine-microsheet-table-container"
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-table': DataViewTable;
  }
}
