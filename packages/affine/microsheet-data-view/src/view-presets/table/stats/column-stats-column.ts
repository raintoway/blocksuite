...
const styles = css`
  ...
  .affine-microsheet-column-stats:hover .stats-cell {
    opacity: 1;
  }
...
export class MicrosheetColumnStatsCell extends SignalWatcher(
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-column-stats-cell': MicrosheetColumnStatsCell;
  }
}
