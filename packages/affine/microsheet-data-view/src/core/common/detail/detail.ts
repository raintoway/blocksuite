...
const styles = css`
  ${unsafeCSS(dataViewCommonStyle('affine-microsheet-data-view-record-detail'))}
      ...
      >
        ...
        ${repeat(
          ...
          property => {
            return keyed(
              this.rowId,
              html` <affine-microsheet-data-view-record-field
                .view="${this.view}"
                .column="${property}"
                .rowId="${this.rowId}"
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-data-view-record-detail': RecordDetail;
  }
}
export const createRecordDetail = (ops: {
  ...
  return html` <affine-microsheet-data-view-record-detail
    .view=${ops.view}
    .rowId=${ops.rowId}
