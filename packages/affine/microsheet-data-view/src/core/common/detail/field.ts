...
export class RecordField extends SignalWatcher(
  ...
  static override styles = css`
    ...
    affine-microsheet-data-view-record-field .icon {
      display: flex;
      align-items: center;
      width: 16px;
      height: 16px;
    ...
    affine-microsheet-data-view-record-field .icon svg {
      width: 16px;
      height: 16px;
    ...
    .field-content .affine-microsheet-number {
      text-align: left;
    ...
    return html`
      <div>
        <div class="field-left" @click="${this._clickLeft}">
          <div class="icon">
            <microsheet-uni-lit .uni="${this.column.icon}"></microsheet-uni-lit>
          </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-microsheet-data-view-record-field': RecordField;
  }
}
